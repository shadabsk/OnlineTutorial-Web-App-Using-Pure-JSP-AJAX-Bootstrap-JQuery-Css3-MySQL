...
<head>
	...
	<script src="Js/loadPageST.js"></script>
...
<div id="side" class="bg-dark" style="width: 18%; float:left">
	...
	<ul>
		<br>
		<button id='StPF'>My Profile</button>
		<!--<button id='StCS'>Available Courses Overview</button>-->
		<!--<button id='StCH'>Select Courses</button>-->
		<button id='StMM'>Current Course</button>

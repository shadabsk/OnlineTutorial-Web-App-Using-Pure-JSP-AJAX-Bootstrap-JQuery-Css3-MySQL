...
if(a!=null && b!=null && c!=null && d!=null && e!=null && f!=null && g!=null && h!=null && i!=null && j!=null && k!=null && l!=null)
{
	try{
        ...
        if(check>0){
        	String result="<div class='alert alert-info'><a href='JSP/Login/login-form.jsp'>Successfully Registered!!!Click here to be redirected to login page</a></div>";
...
if(a!=null){
	try{
			...
			Class.forName("com.mysql.jdbc.Driver").newInstance();
			String query2="insert into belongs (GroupName,Username) values ('Student',?)";
